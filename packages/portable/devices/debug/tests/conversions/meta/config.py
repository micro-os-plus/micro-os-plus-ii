    ...
    children=[
        ...
        Configuration(
            ...
            children=[
                ...
                Configuration(
                    id='config.os.portable.devices.debug.tests.conversions.osx.cl-sjlj.x64.llvm.debug',
                    name='Debug OS X sjlj conversion test configuration with x86_64 LLVM',
                ...
                Configuration(
                    id='config.os.portable.devices.debug.tests.conversions.osx.cl-sjlj.x64.llvm.release',
                    name='Release OS X sjlj conversion test configuration with x86_64 LLVM',
                ...
                Configuration(
                    id='config.os.portable.devices.debug.tests.conversions.osx.cl-sjlj.x32.llvm.debug',
                    name='Debug OS X sjlj conversion test configuration with i386 LLVM',
                    description='Debug build configuration for conversions',
                    ...
                    #    'DEBUG=1',
                    #],
                    toolchain='toolchain.osx.x32.llvm.debug',
                ),
