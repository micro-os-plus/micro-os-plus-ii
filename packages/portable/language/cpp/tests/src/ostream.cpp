...
// test/input.output/iostream.format/output.stream/ostream/types.pass.cpp
  ...
  ts.reportInfo("Test ostream types");
    {
      ...
      ts.assertCondition((os::std::is_same<basic_ostream<char>::traits_type, char_traits<char> >::value));
      ts.assertCondition((os::std::is_same<basic_ostream<char>::int_type, char_traits<char>::int_type>::value));
      ts.assertCondition((os::std::is_same<basic_ostream<char>::pos_type, char_traits<char>::pos_type>::value));
      ts.assertCondition((os::std::is_same<basic_ostream<char>::off_type, char_traits<char>::off_type>::value));
    }
}
