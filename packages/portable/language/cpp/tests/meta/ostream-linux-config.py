...
# GCC x64
Configuration(
    id='config.os.portable.core.tests.ostream.linux.x64.gcc.debug',
...
Configuration(
    id='config.os.portable.core.tests.ostream.linux.x64.gcc.release',
...
# GCC x32
Configuration(
    id='config.os.portable.core.tests.ostream.linux.x32.gcc.debug',
...
Configuration(
    id='config.os.portable.core.tests.ostream.linux.x32.gcc.release',
...
# GCC 4.6 x64
Configuration(
    id='config.os.portable.core.tests.ostream.linux.x64.gcc46.debug',
    name='Debug GNU/Linux C++ ostream configuration with x86_64 GCC 4.6',
    description='Debug build configuration for C++ ostream.',
    
    buildConfigurationName='linux_ostream_x64_gcc46_Debug',
...
Configuration(
    id='config.os.portable.core.tests.ostream.linux.x64.gcc46.release',
    name='Release GNU/Linux C++ ostream configuration with x86_64 GCC 4.6',
    description='Release build configuration for C++ ostream.',
    
    buildConfigurationName='linux_ostream_x64_gcc46_Release',
...
# GCC 4.6 x32
Configuration(
    id='config.os.portable.core.tests.ostream.linux.x32.gcc46.debug',
    name='Debug GNU/Linux C++ ostream configuration with i386 GCC 4.6',
    description='Debug build configuration for C++ ostream.',
    
    buildConfigurationName='linux_ostream_x32_gcc46_Debug',
...
Configuration(
    id='config.os.portable.core.tests.ostream.linux.x32.gcc46.release',
    name='Release GNU/Linux C++ ostream configuration with i386 GCC 4.6',
    description='Release build configuration for C++ ostream.',
    
    buildConfigurationName='linux_ostream_x32_gcc46_Release',
...
# GCC 4.7 x64
Configuration(
    id='config.os.portable.core.tests.ostream.linux.x64.gcc47.debug',
    name='Debug GNU/Linux C++ ostream configuration with x86_64 GCC 4.7',
    description='Debug build configuration for C++ ostream.',
    
    buildConfigurationName='linux_ostream_x64_gcc47_Debug',
...
Configuration(
    id='config.os.portable.core.tests.ostream.linux.x64.gcc47.release',
    name='Release GNU/Linux C++ ostream configuration with x86_64 GCC 4.7',
    description='Release build configuration for C++ ostream.',
    
    buildConfigurationName='linux_ostream_x64_gcc47_Release',
...
# GCC 4.7 x32
Configuration(
    id='config.os.portable.core.tests.ostream.linux.x32.gcc47.debug',
    name='Debug GNU/Linux C++ ostream configuration with i386 GCC 4.7',
    description='Debug build configuration for C++ ostream.',
    
    buildConfigurationName='linux_ostream_x32_gcc47_Debug',
...
Configuration(
    id='config.os.portable.core.tests.ostream.linux.x32.gcc47.release',
    name='Release GNU/Linux C++ ostream configuration with i386 GCC 4.7',
    description='Release build configuration for C++ ostream.',
    
    buildConfigurationName='linux_ostream_x32_gcc47_Release',
...
# LLVM x64
Configuration(
    id='config.os.portable.core.tests.ostream.linux.x64.llvm.debug',
    name='Debug GNU/Linux C++ ostream configuration with x86_64 LLVM',
    description='Debug build configuration for C++ ostream.',
    
    buildConfigurationName='linux_ostream_x64_llvm_Debug',
...
Configuration(
    id='config.os.portable.core.tests.ostream.linux.x64.llvm.release',
    name='Release GNU/Linux C++ ostream configuration with x86_64 LLVM',
    description='Release build configuration for C++ ostream.',
    
    buildConfigurationName='linux_ostream_x64_llvm_Release',
...
# LLVM x32
Configuration(
    id='config.os.portable.core.tests.ostream.linux.x32.llvm.debug',
    name='Debug GNU/Linux C++ ostream configuration with i386 LLVM',
    description='Debug build configuration for C++ ostream.',
    
    buildConfigurationName='linux_ostream_x32_llvm_Debug',
...
Configuration(
    id='config.os.portable.core.tests.ostream.linux.x32.llvm.release',
    name='Release GNU/Linux C++ ostream configuration with i386 LLVM',
    description='Release build configuration for C++ ostream.',
    
    buildConfigurationName='linux_ostream_x32_llvm_Release',
