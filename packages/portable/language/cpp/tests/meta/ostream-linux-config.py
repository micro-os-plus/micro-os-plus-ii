...
# ----- GCC 4.8 x64 -----------------------------------------------------------
Configuration(
    id='config.os.portable.core.tests.ostream.linux.x64.gcc48.debug',
    name='Debug GNU/Linux C++ ostream configuration with x86_64 GCC 4.8',
    description='Debug build configuration for C++ ostream.',
    
    buildConfigurationName='linux_ostream_x64_gcc48_Debug',
...
Configuration(
    id='config.os.portable.core.tests.ostream.linux.x64.gcc48.release',
    name='Release GNU/Linux C++ ostream configuration with x86_64 GCC 4.8',
    description='Release build configuration for C++ ostream.',
    
    buildConfigurationName='linux_ostream_x64_gcc48_Release',
...
# ----- GCC 4.8 x32 -----------------------------------------------------------
Configuration(
    id='config.os.portable.core.tests.ostream.linux.x32.gcc48.debug',
    name='Debug GNU/Linux C++ ostream configuration with i386 GCC 4.8',
    description='Debug build configuration for C++ ostream.',
    
    buildConfigurationName='linux_ostream_x32_gcc48_Debug',
...
Configuration(
    id='config.os.portable.core.tests.ostream.linux.x32.gcc48.release',
    name='Release GNU/Linux C++ ostream configuration with i386 GCC 4.8',
    description='Release build configuration for C++ ostream.',
    
    buildConfigurationName='linux_ostream_x32_gcc48_Release',
