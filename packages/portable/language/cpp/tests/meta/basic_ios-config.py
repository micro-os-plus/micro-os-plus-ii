    ...
    children=[
        ...
        Configuration(
            ...
            children=[
                ...
                # LLVM x32      
                Configuration(
                    id='config.os.portable.language.cpp.tests.basic_ios.osx.x32.llvm.debug',
                    name='Debug OS X C++ basic_ios configuration with i386 LLVM',
                    description='Debug build configuration for basic_ios.',
                    
                    buildConfigurationName='osx_basic_ios_x32_llvm_Debug',
                ...
                Configuration(
                    id='config.os.portable.language.cpp.tests.basic_ios.osx.x32.llvm.release',
                    name='Release OS X C++ basic_ios configuration with i386 LLVM',
                    description='Release build configuration for basic_ios.',
                    
                    buildConfigurationName='osx_basic_ios_x32_llvm_Release',
                ...
                Configuration(
                    id='config.os.portable.language.cpp.tests.basic_ios.osx.x64.gcc47.release',
                    name='Release OS X C++ basic_ios configuration with x86_64 GCC 4.7',
                    description='Release build configuration for basic_ios.',
                    
                    buildConfigurationName='osx_basic_ios_x64_gcc47_Release',
                ...
                Configuration(
                    id='config.os.portable.language.cpp.tests.basic_ios.osx.x32.gcc47.release',
                    name='Release OS X C++ basic_ios configuration with i386 GCC 4.7',
                    description='Release build configuration for basic_ios.',
                    
                    buildConfigurationName='osx_basic_ios_x32_gcc47_Release',
                ...
                # GCC 4.6 x64
                Configuration(
                    id='config.os.portable.language.cpp.tests.basic_ios.osx.x64.gcc46.debug',
                    name='Debug OS X C++ basic_ios configuration with x86_64 GCC 4.6',
                    description='Debug build configuration for basic_ios.',
                    
                    buildConfigurationName='osx_basic_ios_x64_gcc46_Debug',
                ...
                Configuration(
                    id='config.os.portable.language.cpp.tests.basic_ios.osx.x64.gcc46.release',
                    name='Release OS X C++ basic_ios configuration with x86_64 GCC 4.6',
                    description='Release build configuration for basic_ios.',
                    
                    buildConfigurationName='osx_basic_ios_x64_gcc46_Release',
                ...
                Configuration(
                    id='config.os.portable.language.cpp.tests.basic_ios.osx.x32.gcc46.release',
                    name='Release OS X C++ basic_ios configuration with i386 GCC 4.6',
                    description='Release build configuration for basic_ios.',
                    
                    buildConfigurationName='osx_basic_ios_x32_gcc46_Release',
        ...
        Configuration(
            ...
            children=[
                ...
                # GCC 4.6 x64
                Configuration(
                    id='config.os.portable.diagnostics.tests.basic_ios.linux.x64.gcc46.debug',
                    name='Debug GNU/Linux basic_ios configuration with x86_64 4.6 GCC',
                    description='Debug build configuration for basic_ios.',
                    
                    buildConfigurationName='linux_basic_ios_x64_gcc46_Debug',
                ...
                Configuration(
                    id='config.os.portable.diagnostics.tests.basic_ios.linux.x64.gcc46.release',
                    name='Release GNU/Linux basic_ios configuration with x86_64 4.6 GCC',
                    description='Release build configuration for basic_ios.',
                    
                    buildConfigurationName='linux_basic_ios_x64_gcc46_Release',
                ...
                # GCC 4.6 x32
                Configuration(
                    id='config.os.portable.diagnostics.tests.basic_ios.linux.x32.gcc46.debug',
                    name='Debug GNU/Linux basic_ios configuration with i386 4.6 GCC',
                    description='Debug build configuration for basic_ios.',
                    
                    buildConfigurationName='linux_basic_ios_x32_gcc46_Debug',
                ...
                Configuration(
                    id='config.os.portable.diagnostics.tests.basic_ios.linux.x32.gcc46.release',
                    name='Release GNU/Linux basic_ios configuration with i386 4.6 GCC',
                    description='Release build configuration for basic_ios.',
                    
                    buildConfigurationName='linux_basic_ios_x32_gcc46_Release',
