...
# ----- GCC 4.8 x64 -----------------------------------------------------------
Configuration(
    id='config.os.portable.core.tests.streambuf.linux.x64.gcc48.debug',
    name='Debug GNU/Linux C++ streambuf configuration with x86_64 GCC 4.8',
    description='Debug build configuration for C++ streambuf.',
    
    buildConfigurationName='linux_streambuf_x64_gcc48_Debug',
...
Configuration(
    id='config.os.portable.core.tests.streambuf.linux.x64.gcc48.release',
    name='Release GNU/Linux C++ streambuf configuration with x86_64 GCC 4.8',
    description='Release build configuration for C++ streambuf.',
    
    buildConfigurationName='linux_streambuf_x64_gcc48_Release',
...
# ----- GCC 4.8 x32 -----------------------------------------------------------
Configuration(
    id='config.os.portable.core.tests.streambuf.linux.x32.gcc48.debug',
    name='Debug GNU/Linux C++ streambuf configuration with i386 GCC 4.8',
    description='Debug build configuration for C++ streambuf.',
    
    buildConfigurationName='linux_streambuf_x32_gcc48_Debug',
...
Configuration(
    id='config.os.portable.core.tests.streambuf.linux.x32.gcc48.release',
    name='Release GNU/Linux C++ streambuf configuration with i386 GCC 4.8',
    description='Release build configuration for C++ streambuf.',
    
    buildConfigurationName='linux_streambuf_x32_gcc48_Release',
