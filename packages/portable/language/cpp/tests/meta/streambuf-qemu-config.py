...
Configuration(
    ...
    buildConfigurationName='qemu_streambuf_osx_aep_gcc_Debug',
...
Configuration(
    ...
    buildConfigurationName='qemu_streambuf_osx_aep_gcc_Release',
...
Configuration(
    ...
    buildConfigurationName='qemu_streambuf_linux_aep_gcc_Debug',
...
Configuration(
    ...
    buildConfigurationName='qemu_streambuf_linux_aep_gcc_Release',
