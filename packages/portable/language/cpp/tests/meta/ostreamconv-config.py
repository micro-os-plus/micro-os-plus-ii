...
Configuration(
    ...
    name='C++ ostream conversions test configuration',
    ...
    children=[
        ...
        Configuration(
            ...
            name='OS X C++ ostream conversions test configuration',
            description='Common Debug/Release definitions for C++ ostream conversions test running on OS X.',
        ...
        Configuration(
            ...
            name='GNU/Linux C++ ostream conversions on test configuration',
            description='Common Debug/Release definitions for C++ ostream conversions test running on GNU/Linux.',
        ...
        Configuration(
            ...
            id='config.os.portable.language.cpp.tests.ostreamconv.qemu',
            name='QEMU ARM C++ ostream conversions test configuration',
            description='Common Debug/Release definitions for C++ ostream conversions test running on QEMU.',
