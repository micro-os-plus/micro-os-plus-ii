...
# ----- LLVM x64 --------------------------------------------------------------
Configuration(
    id='config.os.portable.core.tests.string.osx.x64.llvm.debug',
    name='Debug OS X C++ string configuration with x86_64 LLVM',
    description='Debug build configuration for C++ string.',
    
    buildConfigurationName='osx_string_x64_llvm_Debug',
...
Configuration(
    id='config.os.portable.core.tests.string.osx.x64.llvm.release',
    name='Release OS X C++ string configuration with x86_64 LLVM',
    description='Release build configuration for C++ string.',
    
    buildConfigurationName='osx_string_x64_llvm_Release',
...
# LLVM x32
Configuration(
    id='config.os.portable.core.tests.string.osx.x32.llvm.debug',
    name='Debug OS X C++ string configuration with i386 LLVM',
    description='Debug build configuration for C++ string.',
    
    buildConfigurationName='osx_string_x32_llvm_Debug',
...
Configuration(
    id='config.os.portable.core.tests.string.osx.x32.llvm.release',
    name='Release OS X C++ string configuration with i386 LLVM',
    description='Release build configuration for C++ string.',
    
    buildConfigurationName='osx_string_x32_llvm_Release',
...
# ----- GCC 4.7 x64 -----------------------------------------------------------
Configuration(
    id='config.os.portable.core.tests.string.osx.x64.gcc47.debug',
    name='Debug OS X C++ string configuration with x86_64 GCC 4.7',
    description='Debug build configuration for C++ string.',
    
    buildConfigurationName='osx_string_x64_gcc47_Debug',
...
Configuration(
    id='config.os.portable.core.tests.string.osx.x64.gcc47.release',
    name='Release OS X C++ string configuration with x86_64 GCC 4.7',
    description='Release build configuration for C++ string.',
    
    buildConfigurationName='osx_string_x64_gcc47_Release',
...
# GCC 4.7 x32
Configuration(
    id='config.os.portable.core.tests.string.osx.x32.gcc47.debug',
    name='Debug OS X C++ string configuration with i386 GCC 4.7',
    description='Debug build configuration for C++ string.',
    
    buildConfigurationName='osx_string_x32_gcc47_Debug',
...
Configuration(
    id='config.os.portable.core.tests.string.osx.x32.gcc47.release',
    name='Release OS X C++ string configuration with i386 GCC 4.7',
    description='Release build configuration for C++ string.',
    
    buildConfigurationName='osx_string_x32_gcc47_Release',
...
# ----- GCC 4.8 x64 -----------------------------------------------------------
Configuration(
    id='config.os.portable.core.tests.string.osx.x64.gcc48.debug',
    name='Debug OS X C++ string configuration with x86_64 GCC 4.8',
    description='Debug build configuration for C++ string.',
    
    buildConfigurationName='osx_string_x64_gcc48_Debug',
...
Configuration(
    id='config.os.portable.core.tests.string.osx.x64.gcc48.release',
    name='Release OS X C++ string configuration with x86_64 GCC 4.8',
    description='Release build configuration for C++ string.',
    
    buildConfigurationName='osx_string_x64_gcc48_Release',
...
# GCC 4.8 x32
Configuration(
    id='config.os.portable.core.tests.string.osx.x32.gcc48.debug',
    name='Debug OS X C++ string configuration with i386 GCC 4.8',
    description='Debug build configuration for C++ string.',
    
    buildConfigurationName='osx_string_x32_gcc48_Debug',
...
Configuration(
    id='config.os.portable.core.tests.string.osx.x32.gcc48.release',
    name='Release OS X C++ string configuration with i386 GCC 4.8',
    description='Release build configuration for C++ string.',
    
    buildConfigurationName='osx_string_x32_gcc48_Release',
