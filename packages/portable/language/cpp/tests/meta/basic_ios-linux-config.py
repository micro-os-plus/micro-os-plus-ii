...
# ----- GCC x64 ---------------------------------------------------------------
Configuration(
    id='config.os.portable.core.tests.basic_ios.linux.gcc.x64.debug',
    name='Debug GNU/Linux C++ basic_ios configuration with x86_64 GCC',
    description='Debug build configuration for C++ basic_ios.',
    
    buildConfigurationName='linux_gcc_x64_basic_ios_Debug',
    
    buildFolder='$(PARENT)/gcc/x64/basic_ios/Debug',
...
Configuration(
    id='config.os.portable.core.tests.basic_ios.linux.gcc.x64.release',
    name='Release GNU/Linux C++ basic_ios configuration with x86_64 GCC',
    description='Release build configuration for C++ basic_ios.',
    
    buildConfigurationName='linux_gcc_x64_basic_ios_Release',
    
    buildFolder='$(PARENT)/gcc/x64/basic_ios/Release',
...
# ----- GCC x32 ---------------------------------------------------------------
Configuration(
    id='config.os.portable.core.tests.basic_ios.linux.gcc.x32.debug',
    name='Debug GNU/Linux C++ basic_ios configuration with i386 GCC',
    description='Debug build configuration for C++ basic_ios.',
    
    buildConfigurationName='linux_gcc_x32_basic_ios_Debug',
    
    buildFolder='$(PARENT)/gcc/x32/basic_ios/Debug',
...
Configuration(
    id='config.os.portable.core.tests.basic_ios.linux.gcc.x32.release',
    name='Release GNU/Linux C++ basic_ios configuration with i386 GCC',
    description='Release build configuration for C++ basic_ios.',
    
    buildConfigurationName='linux_gcc_x32_basic_ios_Release',
    
    buildFolder='$(PARENT)/gcc/x32/basic_ios/Release',
...
# ----- GCC 4.7 x64 -----------------------------------------------------------
Configuration(
    id='config.os.portable.core.tests.basic_ios.linux.gcc47.x64.debug',
    name='Debug GNU/Linux C++ basic_ios configuration with x86_64 GCC 4.7',
    description='Debug build configuration for C++ basic_ios.',
    
    buildConfigurationName='linux_gcc47_x64_basic_ios_Debug',
...
Configuration(
    id='config.os.portable.core.tests.basic_ios.linux.gcc47.x64.release',
    name='Release GNU/Linux C++ basic_ios configuration with x86_64 GCC 4.7',
    description='Release build configuration for C++ basic_ios.',
    
    buildConfigurationName='linux_gcc47_x64_basic_ios_Release',
...
# ----- GCC 4.7 x32 -----------------------------------------------------------
Configuration(
    id='config.os.portable.core.tests.basic_ios.linux.gcc47.x32.debug',
    name='Debug GNU/Linux C++ basic_ios configuration with i386 GCC 4.7',
    description='Debug build configuration for C++ basic_ios.',
    
    buildConfigurationName='linux_gcc47_x32_basic_ios_Debug',
...
Configuration(
    id='config.os.portable.core.tests.basic_ios.linux.gcc47.x32.release',
    name='Release GNU/Linux C++ basic_ios configuration with i386 GCC 4.7',
    description='Release build configuration for C++ basic_ios.',
    
    buildConfigurationName='linux_gcc47_x32_basic_ios_Release',
...
# ----- GCC 4.8 x64 -----------------------------------------------------------
Configuration(
    id='config.os.portable.core.tests.basic_ios.linux.gcc48.x64.debug',
    name='Debug GNU/Linux C++ basic_ios configuration with x86_64 GCC 4.8',
    description='Debug build configuration for C++ basic_ios.',
    
    buildConfigurationName='linux_gcc48_x64_basic_ios_Debug',
...
Configuration(
    id='config.os.portable.core.tests.basic_ios.linux.gcc48.x64.release',
    name='Release GNU/Linux C++ basic_ios configuration with x86_64 GCC 4.8',
    description='Release build configuration for C++ basic_ios.',
    
    buildConfigurationName='linux_gcc48_x64_basic_ios_Release',
...
# ----- GCC 4.8 x32 -----------------------------------------------------------
Configuration(
    id='config.os.portable.core.tests.basic_ios.linux.gcc48.x32.debug',
    name='Debug GNU/Linux C++ basic_ios configuration with i386 GCC 4.8',
    description='Debug build configuration for C++ basic_ios.',
    
    buildConfigurationName='linux_gcc48_x32_basic_ios_Debug',
...
Configuration(
    id='config.os.portable.core.tests.basic_ios.linux.gcc48.x32.release',
    name='Release GNU/Linux C++ basic_ios configuration with i386 GCC 4.8',
    description='Release build configuration for C++ basic_ios.',
    
    buildConfigurationName='linux_gcc48_x32_basic_ios_Release',
...
# ----- LLVM x64 --------------------------------------------------------------
Configuration(
    id='config.os.portable.core.tests.basic_ios.linux.llvm.x64.debug',
    name='Debug GNU/Linux C++ basic_ios configuration with x86_64 LLVM',
    description='Debug build configuration for C++ basic_ios.',
    
    buildConfigurationName='linux_llvm_x64_basic_ios_Debug',
...
Configuration(
    id='config.os.portable.core.tests.basic_ios.linux.llvm.x64.release',
    name='Release GNU/Linux C++ basic_ios configuration with x86_64 LLVM',
    description='Release build configuration for C++ basic_ios.',
    
    buildConfigurationName='linux_llvm_x64_basic_ios_Release',
...
# ----- LLVM x32 --------------------------------------------------------------
Configuration(
    id='config.os.portable.core.tests.basic_ios.linux.llvm.x32.debug',
    name='Debug GNU/Linux C++ basic_ios configuration with i386 LLVM',
    description='Debug build configuration for C++ basic_ios.',
    
    buildConfigurationName='linux_llvm_x32_basic_ios_Debug',
...
Configuration(
    id='config.os.portable.core.tests.basic_ios.linux.llvm.x32.release',
    name='Release GNU/Linux C++ basic_ios configuration with i386 LLVM',
    description='Release build configuration for C++ basic_ios.',
    
    buildConfigurationName='linux_llvm_x32_basic_ios_Release',
