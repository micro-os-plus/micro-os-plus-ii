    ...
    children=[
        ...
        Configuration(
            ...
            children=[
                ...
                # GCC 4.6 x64
                Configuration(
                    id='config.os.portable.diagnostics.tests.fpos.linux.x64.gcc46.debug',
                    name='Debug GNU/Linux fpos configuration with x86_64 GCC 4.6',
                    description='Debug build configuration for fpos.',
                ...
                Configuration(
                    id='config.os.portable.diagnostics.tests.fpos.linux.x64.gcc46.release',
                    name='Release GNU/Linux fpos configuration with x86_64 GCC 4.6',
                    description='Release build configuration for fpos.',
                ...
                # GCC 4.6 x32
                Configuration(
                    id='config.os.portable.diagnostics.tests.fpos.linux.x32.gcc46.debug',
                    name='Debug GNU/Linux fpos configuration with i386 GCC 4.6',
                    description='Debug build configuration for fpos.',
                ...
                Configuration(
                    id='config.os.portable.diagnostics.tests.fpos.linux.x32.gcc46.release',
                    name='Release GNU/Linux fpos configuration with i386 GCC 4.6',
                    description='Release build configuration for fpos.',
