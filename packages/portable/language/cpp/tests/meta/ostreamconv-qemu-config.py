...
Configuration(
    ...
    buildConfigurationName='qemu_ostreamconv_osx_aep_gcc_Debug',
...
Configuration(
    ...
    buildConfigurationName='qemu_ostreamconv_osx_aep_gcc_Release',
...
Configuration(
    ...
    buildConfigurationName='qemu_ostreamconv_linux_aep_gcc_Debug',
...
Configuration(
    ...
    buildConfigurationName='qemu_ostreamconv_linux_aep_gcc_Release',
