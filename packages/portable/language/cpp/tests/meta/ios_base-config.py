    ...
    children=[
        ...
        Configuration(
            ...
            children=[
                ...
                # GCC 4.6 x32
                Configuration(
                    id='config.os.portable.language.cpp.tests.ios_base.osx.x32.gcc46.debug',
        ...
        Configuration(
            ...
            children=[
                ...
                # GCC 4.6 x64
                Configuration(
                    id='config.os.portable.diagnostics.tests.ios_base.linux.x64.gcc46.debug',
                    name='Debug GNU/Linux ios_base configuration with x86_64 GCC 4.6',
                    description='Debug build configuration for ios_base.',
                ...
                Configuration(
                    id='config.os.portable.diagnostics.tests.ios_base.linux.x64.gcc46.release',
                    name='Release GNU/Linux ios_base configuration with x86_64 GCC 4.6',
                    description='Release build configuration for ios_base.',
                ...
                # GCC 4.6 x32
                Configuration(
                    id='config.os.portable.diagnostics.tests.ios_base.linux.x32.gcc46.debug',
                    name='Debug GNU/Linux ios_base configuration with i386 GCC 4.6',
                    description='Debug build configuration for ios_base.',
                ...
                Configuration(
                    id='config.os.portable.diagnostics.tests.ios_base.linux.x32.gcc46.release',
                    name='Release GNU/Linux ios_base configuration with i386 GCC 4.6',
                    description='Release build configuration for ios_base.',
