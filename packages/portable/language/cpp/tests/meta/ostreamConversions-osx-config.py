...
# LLVM x64
Configuration(
    id='config.os.portable.core.tests.ostreamconv.osx.x64.llvm.debug',
...
Configuration(
    id='config.os.portable.core.tests.ostreamconv.osx.x64.llvm.release',
...
# LLVM x32
Configuration(
    id='config.os.portable.core.tests.ostreamconv.osx.x32.llvm.debug',
...
Configuration(
    id='config.os.portable.core.tests.ostreamconv.osx.x32.llvm.release',
...
# GCC 4.6 x64
Configuration(
    id='config.os.portable.core.tests.ostreamconv.osx.x64.gcc46.debug',
...
Configuration(
    id='config.os.portable.core.tests.ostreamconv.osx.x64.gcc46.release',
...
# GCC 4.6 x32
Configuration(
    id='config.os.portable.core.tests.ostreamconv.osx.x32.gcc46.debug',
...
Configuration(
    id='config.os.portable.core.tests.ostreamconv.osx.x32.gcc46.release',
...
# GCC 4.7 x64
Configuration(
    id='config.os.portable.core.tests.ostreamconv.osx.x64.gcc47.debug',
...
Configuration(
    id='config.os.portable.core.tests.ostreamconv.osx.x64.gcc47.release',
...
# GCC 4.7 x32
Configuration(
    id='config.os.portable.core.tests.ostreamconv.osx.x32.gcc47.debug',
...
Configuration(
    id='config.os.portable.core.tests.ostreamconv.osx.x32.gcc47.release',
...
# GCC 4.8 x64
Configuration(
    id='config.os.portable.core.tests.ostreamconv.osx.x64.gcc48.debug',
    name='Debug OS X C++ ostream conversions configuration with x86_64 GCC 4.8',
    description='Debug build configuration for C++ ostream conversions.',
    
    buildConfigurationName='osx_ostreamconv_x64_gcc48_Debug',
...
Configuration(
    id='config.os.portable.core.tests.ostreamconv.osx.x64.gcc48.release',
    name='Release OS X C++ ostream conversions configuration with x86_64 GCC 4.8',
    description='Release build configuration for C++ ostream conversions.',
    
    buildConfigurationName='osx_ostreamconv_x64_gcc48_Release',
...
# GCC 4.8 x32
Configuration(
    id='config.os.portable.core.tests.ostreamconv.osx.x32.gcc48.debug',
    name='Debug OS X C++ ostream conversions configuration with i386 GCC 4.8',
    description='Debug build configuration for C++ ostream conversions.',
    
    buildConfigurationName='osx_ostreamconv_x32_gcc48_Debug',
...
Configuration(
    id='config.os.portable.core.tests.ostreamconv.osx.x32.gcc48.release',
    name='Release OS X C++ ostream conversions configuration with i386 GCC 4.8',
    description='Release build configuration for C++ ostream conversions.',
    
    buildConfigurationName='osx_ostreamconv_x32_gcc48_Release',
