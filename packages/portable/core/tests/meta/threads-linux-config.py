...
Configuration(
    ...
    name='Debug GNU/Linux Threads configuration with x86_64 GCC 4.6',
    description='Debug build configuration for Threads.',
...
Configuration(
    ...
    name='Release GNU/Linux Threads configuration with x86_64 GCC 4.6',
    description='Release build configuration for Threads.',
...
Configuration(
    ...
    name='Debug GNU/Linux Threads configuration with i386 GCC 4.6',
    description='Debug build configuration for Threads.',
...
Configuration(
    ...
    name='Release GNU/Linux Threads configuration with i386 GCC 4.6',
    description='Release build configuration for Threads.',
