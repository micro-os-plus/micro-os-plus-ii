...
Configuration(
    ...
    buildConfigurationName='qemu_mutex_osx_aep_gcc_Debug',
...
Configuration(
    ...
    buildConfigurationName='qemu_mutex_osx_aep_gcc_Release',
...
Configuration(
    ...
    buildConfigurationName='qemu_mutex_linux_aep_gcc_Debug',
...
Configuration(
    ...
    buildConfigurationName='qemu_mutex_linux_aep_gcc_Release',
