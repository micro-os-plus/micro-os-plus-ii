...
# GCC 4.6 x64
Configuration(
    id='config.os.portable.core.tests.sleepstress.linux.x64.gcc46.debug',
    name='Debug GNU/Linux Sleep Stress configuration with x86_64 GCC 4.6',
    description='Debug build configuration for Sleep Stress.',
    
    buildConfigurationName='linux_sleepstress_x64_gcc46_Debug',
...
Configuration(
    id='config.os.portable.core.tests.sleepstress.linux.x64.gcc46.release',
    name='Release GNU/Linux Sleep Stress configuration with x86_64 GCC 4.6',
    description='Release build configuration for Sleep Stress.',
    
    buildConfigurationName='linux_sleepstress_x64_gcc46_Release',
...
# GCC 4.6 x32
Configuration(
    id='config.os.portable.core.tests.sleepstress.linux.x32.gcc46.debug',
    name='Debug GNU/Linux Sleep Stress configuration with i386 GCC 4.6',
    description='Debug build configuration for Sleep Stress.',
    
    buildConfigurationName='linux_sleepstress_x32_gcc46_Debug',
...
Configuration(
    id='config.os.portable.core.tests.sleepstress.linux.x32.gcc46.release',
    name='Release GNU/Linux Sleep Stress configuration with i386 GCC 4.6',
    description='Release build configuration for Sleep Stress.',
    
    buildConfigurationName='linux_sleepstress_x32_gcc46_Release',
