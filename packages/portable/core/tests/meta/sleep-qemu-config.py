...
Configuration(
    ...
    buildConfigurationName='qemu_sleep_osx_aep_gcc_Debug',
...
Configuration(
    ...
    buildConfigurationName='qemu_sleep_osx_aep_gcc_Release',
...
Configuration(
    ...
    buildConfigurationName='qemu_sleep_linux_aep_gcc_Debug',
...
Configuration(
    ...
    buildConfigurationName='qemu_sleep_linux_aep_gcc_Release',
