...
Configuration(
    ...
    buildConfigurationName='stm32h103_yields_osx_aep_gcc_Debug',
...
Configuration(
    ...
    buildConfigurationName='stm32h103_yields_osx_aep_gcc_Release',
...
Configuration(
    ...
    buildConfigurationName='stm32h103_yields_linux_aep_gcc_Debug',
...
Configuration(
    ...
    buildConfigurationName='stm32h103_yields_linux_aep_gcc_Release',
