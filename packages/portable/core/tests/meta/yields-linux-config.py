...
# GCC x64
Configuration(
    id='config.os.portable.core.tests.yields.linux.x64.gcc.debug',
    name='Debug GNU/Linux Yields configuration with x86_64 GCC',
    description='Debug build configuration for Yields.',
    
    buildConfigurationName='linux_yields_x64_gcc_Debug',
...
Configuration(
    id='config.os.portable.core.tests.yields.linux.x64.gcc.release',
    name='Release GNU/Linux Yields configuration with x86_64 GCC',
    description='Release build configuration for Yields.',
    
    buildConfigurationName='linux_yields_x64_gcc_Release',
...
Configuration(
    ...
    buildConfigurationName='linux_yields_x32_gcc_Debug',
...
Configuration(
    id='config.os.portable.core.tests.yields.linux.x32.gcc.release',
    name='Release GNU/Linux Yields configuration with i386 GCC',
    description='Release build configuration for Yields.',
    
    buildConfigurationName='linux_yields_x32_gcc_Release',
...
# GCC 4.6 x64
Configuration(
    id='config.os.portable.core.tests.yields.linux.x64.gcc46.debug',
    name='Debug GNU/Linux Yields configuration with x86_64 GCC 4.6',
    description='Debug build configuration for Yields.',
    
    buildConfigurationName='linux_yields_x64_gcc46_Debug',
...
Configuration(
    id='config.os.portable.core.tests.yields.linux.x64.gcc46.release',
    name='Release GNU/Linux Yields configuration with x86_64 GCC 4.6',
    description='Release build configuration for Yields.',
    
    buildConfigurationName='linux_yields_x64_gcc46_Release',
...
# GCC 4.6 x32
Configuration(
    id='config.os.portable.core.tests.yields.linux.x32.gcc46.debug',
    name='Debug GNU/Linux Yields configuration with i386 GCC 4.6',
    description='Debug build configuration for Yields.',
    
    buildConfigurationName='linux_yields_x32_gcc46_Debug',
...
Configuration(
    id='config.os.portable.core.tests.yields.linux.x32.gcc46.release',
    name='Release GNU/Linux Yields configuration with i386 GCC 4.6',
    description='Release build configuration for Yields.',
    
    buildConfigurationName='linux_yields_x32_gcc46_Release',
...
# GCC 4.7 x64
Configuration(
    id='config.os.portable.core.tests.yields.linux.x64.gcc47.debug',
    name='Debug GNU/Linux Yields configuration with x86_64 GCC 4.7',
    description='Debug build configuration for Yields.',
    
    buildConfigurationName='linux_yields_x64_gcc47_Debug',
...
Configuration(
    id='config.os.portable.core.tests.yields.linux.x64.gcc47.release',
    name='Release GNU/Linux Yields configuration with x86_64 GCC 4.7',
    description='Release build configuration for Yields.',
    
    buildConfigurationName='linux_yields_x64_gcc47_Release',
...
Configuration(
    ...
    buildConfigurationName='linux_yields_x32_gcc47_Debug',
...
Configuration(
    id='config.os.portable.core.tests.yields.linux.x32.gcc47.release',
    name='Release GNU/Linux Yields configuration with i386 GCC 4.7',
    description='Release build configuration for Yields.',
    
    buildConfigurationName='linux_yields_x32_gcc47_Release',
...
# LLVM x64
Configuration(
    id='config.os.portable.core.tests.yields.linux.x64.llvm.debug',
    name='Debug GNU/Linux Yields configuration with x86_64 LLVM',
    description='Debug build configuration for Yields.',
    
    buildConfigurationName='linux_yields_x64_llvm_Debug',
...
Configuration(
    id='config.os.portable.core.tests.yields.linux.x64.llvm.release',
    name='Release GNU/Linux Yields configuration with x86_64 LLVM',
    description='Release build configuration for Yields.',
    
    buildConfigurationName='linux_yields_x64_llvm_Release',
...
Configuration(
    ...
    buildConfigurationName='linux_yields_x32_llvm_Debug',
...
Configuration(
    id='config.os.portable.core.tests.yields.linux.x32.llvm.release',
    name='Release GNU/Linux Yields configuration with i386 LLVM',
    description='Release build configuration for Yields.',
    
    buildConfigurationName='linux_yields_x32_llvm_Release',
