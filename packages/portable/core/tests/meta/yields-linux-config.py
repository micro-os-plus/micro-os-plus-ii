...
# ----- GCC 4.8 x64 -----------------------------------------------------------
Configuration(
    id='config.os.portable.core.tests.yields.linux.x64.gcc48.debug',
    name='Debug GNU/Linux Yields configuration with x86_64 GCC 4.8',
    description='Debug build configuration for Yields.',
    
    buildConfigurationName='linux_yields_x64_gcc48_Debug',
...
Configuration(
    id='config.os.portable.core.tests.yields.linux.x64.gcc48.release',
    name='Release GNU/Linux Yields configuration with x86_64 GCC 4.8',
    description='Release build configuration for Yields.',
    
    buildConfigurationName='linux_yields_x64_gcc48_Release',
...
Configuration(
    ...
    buildConfigurationName='linux_yields_x32_gcc48_Debug',
...
Configuration(
    id='config.os.portable.core.tests.yields.linux.x32.gcc48.release',
    name='Release GNU/Linux Yields configuration with i386 GCC 4.8',
    description='Release build configuration for Yields.',
    
    buildConfigurationName='linux_yields_x32_gcc48_Release',
