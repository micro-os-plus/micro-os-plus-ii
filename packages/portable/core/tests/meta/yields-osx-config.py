...
# ----- GCC 4.8 x64 -----------------------------------------------------------
Configuration(
    id='config.os.portable.core.tests.yields.osx.x64.gcc48.debug',
    name='Debug OS X Yields configuration with x86_64 GCC 4.8',
    description='Debug build configuration for Yields.',
    
    buildConfigurationName='osx_yields_x64_gcc48_Debug',
...
Configuration(
    id='config.os.portable.core.tests.yields.osx.x64.gcc48.release',
    name='Release OS X Yields configuration with x86_64 GCC 4.8',
    description='Release build configuration for Yields.',
    
    buildConfigurationName='osx_yields_x64_gcc48_Release',
...
# ----- GCC 4.8 x32 -----------------------------------------------------------
Configuration(
    id='config.os.portable.core.tests.yields.osx.x32.gcc48.debug',
    name='Debug OS X Yields configuration with i386 GCC 4.8',
    description='Debug build configuration for Yields.',
    
    buildConfigurationName='osx_yields_x32_gcc48_Debug',
...
Configuration(
    id='config.os.portable.core.tests.yields.osx.x32.gcc48.release',
    name='Release OS X Yields configuration with i386 GCC 4.8',
    description='Release build configuration for Yields.',
    
    buildConfigurationName='osx_yields_x32_gcc48_Release',
