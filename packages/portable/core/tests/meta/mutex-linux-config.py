...
# ----- GCC x64 ---------------------------------------------------------------
Configuration(
    id='config.os.portable.core.tests.mutex.linux.x64.gcc.debug',
    name='Debug GNU/Linux Mutex configuration with x86_64 GCC',
    description='Debug build configuration for Mutex.',
    
    buildConfigurationName='linux_mutex_x64_gcc_Debug',
...
Configuration(
    id='config.os.portable.core.tests.mutex.linux.x64.gcc.release',
    name='Release GNU/Linux Mutex configuration with x86_64 GCC',
    description='Release build configuration for Mutex.',
    
    buildConfigurationName='linux_mutex_x64_gcc_Release',
...
# GCC x32
Configuration(
    id='config.os.portable.core.tests.mutex.linux.x32.gcc.debug',
    name='Debug GNU/Linux Mutex configuration with i386 GCC',
    description='Debug build configuration for Mutex.',
    
    buildConfigurationName='linux_mutex_x32_gcc_Debug',
...
Configuration(
    id='config.os.portable.core.tests.mutex.linux.x32.gcc.release',
    name='Release GNU/Linux Mutex configuration with i386 GCC',
    description='Release build configuration for Mutex.',
    
    buildConfigurationName='linux_mutex_x32_gcc_Release',
...
# ----- GCC 4.7 x64 -----------------------------------------------------------
Configuration(
    id='config.os.portable.core.tests.mutex.linux.x64.gcc47.debug',
    name='Debug GNU/Linux Mutex configuration with x86_64 GCC 4.7',
    description='Debug build configuration for Mutex.',
    
    buildConfigurationName='linux_mutex_x64_gcc47_Debug',
...
Configuration(
    id='config.os.portable.core.tests.mutex.linux.x64.gcc47.release',
    name='Release GNU/Linux Mutex configuration with x86_64 GCC 4.7',
    description='Release build configuration for Mutex.',
    
    buildConfigurationName='linux_mutex_x64_gcc47_Release',
...
# GCC 4.7 x32
Configuration(
    id='config.os.portable.core.tests.mutex.linux.x32.gcc47.debug',
    name='Debug GNU/Linux Mutex configuration with i386 GCC 4.7',
    description='Debug build configuration for Mutex.',
    
    buildConfigurationName='linux_mutex_x32_gcc47_Debug',
...
Configuration(
    id='config.os.portable.core.tests.mutex.linux.x32.gcc47.release',
    name='Release GNU/Linux Mutex configuration with i386 GCC 4.7',
    description='Release build configuration for Mutex.',
    
    buildConfigurationName='linux_mutex_x32_gcc47_Release',
...
# ----- GCC 4.8 x64 -----------------------------------------------------------
Configuration(
    id='config.os.portable.core.tests.mutex.linux.x64.gcc48.debug',
    name='Debug GNU/Linux Mutex configuration with x86_64 GCC 4.8',
    description='Debug build configuration for Mutex.',
    
    buildConfigurationName='linux_mutex_x64_gcc48_Debug',
...
Configuration(
    id='config.os.portable.core.tests.mutex.linux.x64.gcc48.release',
    name='Release GNU/Linux Mutex configuration with x86_64 GCC 4.8',
    description='Release build configuration for Mutex.',
    
    buildConfigurationName='linux_mutex_x64_gcc48_Release',
...
# GCC 4.8 x32
Configuration(
    id='config.os.portable.core.tests.mutex.linux.x32.gcc48.debug',
    name='Debug GNU/Linux Mutex configuration with i386 GCC 4.8',
    description='Debug build configuration for Mutex.',
    
    buildConfigurationName='linux_mutex_x32_gcc48_Debug',
...
Configuration(
    id='config.os.portable.core.tests.mutex.linux.x32.gcc48.release',
    name='Release GNU/Linux Mutex configuration with i386 GCC 4.8',
    description='Release build configuration for Mutex.',
    
    buildConfigurationName='linux_mutex_x32_gcc48_Release',
...
# ----- LLVM x64 --------------------------------------------------------------
Configuration(
    id='config.os.portable.core.tests.mutex.linux.x64.llvm.debug',
    name='Debug GNU/Linux Mutex configuration with x86_64 LLVM',
    description='Debug build configuration for Mutex.',
    
    buildConfigurationName='linux_mutex_x64_llvm_Debug',
...
Configuration(
    id='config.os.portable.core.tests.mutex.linux.x64.llvm.release',
    name='Release GNU/Linux Mutex configuration with x86_64 LLVM',
    description='Release build configuration for Mutex.',
    
    buildConfigurationName='linux_mutex_x64_llvm_Release',
...
# LLVM x32
Configuration(
    id='config.os.portable.core.tests.mutex.linux.x32.llvm.debug',
    name='Debug GNU/Linux Mutex configuration with i386 LLVM',
    description='Debug build configuration for Mutex.',
    
    buildConfigurationName='linux_mutex_x32_llvm_Debug',
...
Configuration(
    id='config.os.portable.core.tests.mutex.linux.x32.llvm.release',
    name='Release GNU/Linux Mutex configuration with i386 LLVM',
    description='Release build configuration for Mutex.',
    
    buildConfigurationName='linux_mutex_x32_llvm_Release',
