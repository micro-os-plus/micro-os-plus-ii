...
# GCC 4.6 x64
Configuration(
    id='config.os.portable.core.tests.trace.linux.x64.gcc46.debug',
...
Configuration(
    id='config.os.portable.core.tests.trace.linux.x64.gcc46.release',
...
# GCC 4.6 x32
Configuration(
    id='config.os.portable.core.tests.trace.linux.x32.gcc46.debug',
...
Configuration(
    id='config.os.portable.core.tests.trace.linux.x32.gcc46.release',
