...
# ----- GCC 4.8 x64 -----------------------------------------------------------
Configuration(
    id='config.os.portable.tests.minimal.osx.x64.gcc48.debug',
    name='Debug OS X Minimal configuration with x86_64 GCC 4.8',
    description='Debug build configuration for Minimal.',
    
    buildConfigurationName='osx_minimal_x64_gcc48_Debug',
...
Configuration(
    id='config.os.portable.tests.minimal.osx.x64.gcc48.release',
    name='Release OS X Minimal configuration with x86_64 GCC 4.8',
    description='Release build configuration for Minimal.',
    
    buildConfigurationName='osx_minimal_x64_gcc48_Release',
...
# GCC 4.8 x32
Configuration(
    id='config.os.portable.tests.minimal.osx.x32.gcc48.debug',
    name='Debug OS X Minimal configuration with i386 GCC 4.8',
    description='Debug build configuration for Minimal.',
    
    buildConfigurationName='osx_minimal_x32_gcc48_Debug',
...
Configuration(
    id='config.os.portable.tests.minimal.osx.x32.gcc48.release',
    name='Release OS X Minimal configuration with i386 GCC 4.8',
    description='Release build configuration for Minimal.',
    
    buildConfigurationName='osx_minimal_x32_gcc48_Release',
