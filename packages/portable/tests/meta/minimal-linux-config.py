...
Configuration(
    ...
    buildConfigurationName='linux_minimal_x64_gcc47_Debug',
...
Configuration(
    id='config.os.portable.tests.minimal.linux.x64.gcc47.release',
    name='Release GNU/Linux Minimal configuration with x86_64 GCC 4.7',
    description='Release build configuration for Minimal.',
    
    buildConfigurationName='linux_minimal_x64_gcc47_Release',
...
# GCC 4.7 x32
Configuration(
    id='config.os.portable.tests.minimal.linux.x32.gcc47.debug',
    name='Debug GNU/Linux Minimal configuration with i386 GCC 4.7',
    description='Debug build configuration for Minimal.',
    
    buildConfigurationName='linux_minimal_x32_gcc47_Debug',
...
Configuration(
    id='config.os.portable.tests.minimal.linux.x32.gcc47.release',
    name='Release GNU/Linux Minimal configuration with i386 GCC 4.7',
    description='Release build configuration for Minimal.',
    
    buildConfigurationName='linux_minimal_x32_gcc47_Release',
...
Configuration(
    ...
    buildConfigurationName='linux_minimal_x64_llvm_Debug',
...
Configuration(
    id='config.os.portable.tests.minimal.linux.x64.llvm.release',
    name='Release GNU/Linux Minimal configuration with x86_64 LLVM',
    description='Release build configuration for Minimal.',
    
    buildConfigurationName='linux_minimal_x64_llvm_Release',
...
# LLVM x32
Configuration(
    id='config.os.portable.tests.minimal.linux.x32.llvm.debug',
    name='Debug GNU/Linux Minimal configuration with i386 LLVM',
    description='Debug build configuration for Minimal.',
    
    buildConfigurationName='linux_minimal_x32_llvm_Debug',
...
Configuration(
    id='config.os.portable.tests.minimal.linux.x32.llvm.release',
    name='Release GNU/Linux Minimal configuration with i386 LLVM',
    description='Release build configuration for Minimal.',
    
    buildConfigurationName='linux_minimal_x32_llvm_Release',
