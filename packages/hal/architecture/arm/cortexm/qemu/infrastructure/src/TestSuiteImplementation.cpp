...
#if defined(OS_INCLUDE_HAL_ARCHITECTURE_ARM_CORTEXM_QEMU_INFRASTRUCTURE_TESTSUITEIMPLEMENTATION) || defined(__DOXYGEN__)
...
namespace hal
{
  namespace qemu
  {
    namespace infra
    {
      ...
      void
      TestSuiteImplementation::processMainParameters(int argc __attribute__((unused)), char* argv[] __attribute__((unused)))
      {
#if 0
        opterr = 0;
        int c;
      ...
      /// XML file.
      ssize_t
      TestSuiteImplementation::writeToXmlFile(const void *cpBuf __attribute__((unused)),
...
#pragma GCC diagnostic pop
      ...
      ssize_t
      TestSuiteImplementation::putBytes(const void* cpBuf __attribute__((unused)), size_t numBytes __attribute__((unused)))
      {
#if 0
