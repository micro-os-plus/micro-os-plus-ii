...
/// \file
/// \brief QEMU semihosting declarations of the trace implementation class.

#ifndef HAL_ARCHITECTURE_ARM_CORTEXM_QEMU_DIAGNOSTICS_TRACEIMPLEMENTATIONSEMIHOSTING_H_
#define HAL_ARCHITECTURE_ARM_CORTEXM_QEMU_DIAGNOSTICS_TRACEIMPLEMENTATIONSEMIHOSTING_H_
...
namespace hal
{
  namespace qemu
  {
    namespace diag
    {
      ...
      /// \headerfile TraceImplementationSemihosting.h "hal/architecture/arm/cortexm/qemu/diagnostics/include/TraceImplementationSemihosting.h"
      /// \ingroup qemu_diag
      /// \nosubgrouping
      ///
      /// \brief The QEMU semihosting version of the TraceImplementation.
      ///
      /// \details
...
namespace os
{
  namespace diag
  {
    ...
    /// for the Trace.
    using TraceImplementation = hal::qemu::diag::TraceImplementationSemihosting;
  } // namespace diag
} // namespace os

#endif // !defined(__DOXYGEN__)
#endif // defined(OS_INCLUDE_HAL_ARCHITECTURE_ARM_CORTEXM_DIAGNOSTICS_QEMU_TRACEIMPLEMENTATIONSEMIHOSTING)
#endif // HAL_ARCHITECTURE_ARM_CORTEXM_QEMU_DIAGNOSTICS_TRACEIMPLEMENTATIONSEMIHOSTING_H_
