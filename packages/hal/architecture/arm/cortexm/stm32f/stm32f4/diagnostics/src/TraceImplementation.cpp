...
namespace hal
{
  namespace stm32f4
  {
    namespace diag
    {
      ...
      static constexpr gpio::portNumber_t SDA_PORT =
          OS_INTEGER_PORTABLE_DIAGNOSTICS_TRACE_I2C_SDA_PORT;
      static constexpr gpio::bitNumber_t SDA_BIT =
          OS_INTEGER_PORTABLE_DIAGNOSTICS_TRACE_I2C_SDA_BIT;

      static constexpr gpio::portNumber_t SCL_PORT =
          OS_INTEGER_PORTABLE_DIAGNOSTICS_TRACE_I2C_SCL_PORT;
      static constexpr gpio::bitNumber_t SCL_BIT =
