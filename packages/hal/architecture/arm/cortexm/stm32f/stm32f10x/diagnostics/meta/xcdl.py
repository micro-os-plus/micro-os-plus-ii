...
Component(
    id='component.os.hal.architecture.arm.cortexm.stm32f10x.diagnostics',
    ...
    children=[
        ...
        Component(
            id='component.os.hal.architecture.arm.cortexm.stm32f10x.diagnostics.trace',
            name='ST Micro STM32F10X trace implementation',
            description='Implementation to output data from the trace class.',
            
            headerDefinition='OS_INCLUDE_HAL_ARCHITECTURE_ARM_CORTEXM_STM32F_STM32F10X_DIAGNOSTICS_TRACEIMPLEMENTATION',
