...
namespace hal
{
  namespace stm32f10xxl
  {
    ...
    public:
      ...
      static constexpr interruptNumber_t Timer1Break_TIM9 = 24; ///< TIM1 Break Interrupt and TIM9 global Interrupt
      static constexpr interruptNumber_t Timer1Update_TIM10 = 25; ///< TIM1 Update Interrupt and TIM10 global Interrupt
      static constexpr interruptNumber_t Timer1TriggerCommutation_TIM11 = 26; ///< TIM1 Trigger and Commutation Interrupt and TIM11 global interrupt
      ...
      static constexpr interruptNumber_t TIM8_BRK_TIM12 = 43; ///< TIM8 Break Interrupt and TIM12 global Interrupt
      static constexpr interruptNumber_t TIM8_UP_TIM13 = 44; ///< TIM8 Update Interrupt and TIM13 global Interrupt
      static constexpr interruptNumber_t TIM8_TRG_COM_TIM14 = 45; ///< TIM8 Trigger and Commutation Interrupt and TIM14 global interrupt
