...
namespace hal
{
  namespace stm32f10xhdvl
  {
    ...
    public:
      ...
      static constexpr interruptNumber_t TIM12 = 43; ///< TIM12 global Interrupt
      static constexpr interruptNumber_t TIM13 = 44; ///< TIM13 global Interrupt
      static constexpr interruptNumber_t TIM14 = 45; ///< TIM14 global Interrupt
      ...
      static constexpr interruptNumber_t DMA2_Channel5 = 60; ///< DMA2 Channel 5 global Interrupt (DMA2 Channel 5 is mapped at position 60 only if the MISC_REMAP bit in the AFIO_MAPR2 register is set)
