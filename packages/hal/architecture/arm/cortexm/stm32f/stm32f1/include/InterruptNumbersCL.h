...
namespace hal
{
  namespace stm32f10xcl
  {
    ...
    public:
      ...
      static constexpr interruptNumber_t CAN1_TX = 19; ///< USB Device High Priority or CAN1 TX Interrupts
      static constexpr interruptNumber_t CAN1_RX0 = 20; ///< USB Device Low Priority or CAN1 RX0 Interrupts
      ...
      static constexpr interruptNumber_t OTG_FS_Wakeup = 42; ///< USB OTG FS WakeUp from suspend through ExternalLine Line Interrupt
      ...
      static constexpr interruptNumber_t TIM6Global = 54; ///< TIM6 Global Interrupt
      static constexpr interruptNumber_t TIM7Global = 55; ///< TIM7 Global Interrupt
      static constexpr interruptNumber_t DMA2Channel1 = 56; ///< DMA2 Channel 1 Global Interrupt
      static constexpr interruptNumber_t DMA2Channel2 = 57; ///< DMA2 Channel 2 Global Interrupt
      static constexpr interruptNumber_t DMA2Channel3 = 58; ///< DMA2 Channel 3 Global Interrupt
      static constexpr interruptNumber_t DMA2Channel4 = 59; ///< DMA2 Channel 4 Global Interrupt
      static constexpr interruptNumber_t DMA2Channel5 = 60; ///< DMA2 Channel 5 Global Interrupt
      static constexpr interruptNumber_t ETHGlobal = 61; ///< Ethernet Global Interrupt
      static constexpr interruptNumber_t ETHWakeup = 62; ///< Ethernet Wakeup through ExternalLine line Interrupt
      static constexpr interruptNumber_t CAN2_TX = 63; ///< CAN2 TX Interrupt
      static constexpr interruptNumber_t CAN2_RX0 = 64; ///< CAN2 RX0 Interrupt
      static constexpr interruptNumber_t CAN2_RX1 = 65; ///< CAN2 RX1 Interrupt
      static constexpr interruptNumber_t CAN2_SCE = 66; ///< CAN2 SCE Interrupt
      static constexpr interruptNumber_t OTG_FS = 67; ///< USB OTG FS Global Interrupt
