...
Configuration(
    ...
    children=[
        ...
        Configuration(
            id='config.os.hal.architecture.arm.cortexm.tests.cmsis.stm32h103.osx.aep.gcc.debug',
            name='Debug STM32-H103 CMSIS configuration with ARM Embedded GCC on OS X',
            description='Debug build configuration for CMSIS.',
            
            buildConfigurationName='stm32h103_cmsis_osx_aep_gcc_Debug',
        ...
        Configuration(
            id='config.os.hal.architecture.arm.cortexm.tests.cmsis.stm32h103.osx.aep.gcc.release',
            name='Release STM32-H103 CMSIS configuration with ARM Embedded GCC on OS X',
            description='Release build configuration for CMSIS.',
            
            buildConfigurationName='stm32h103_cmsis_osx_aep_gcc_Release',
        ...
        Configuration(
            id='config.os.hal.architecture.arm.cortexm.tests.cmsis.stm32h103.linux.aep.gcc.debug',
            name='Debug STM32-H103 CMSIS configuration with ARM Embedded GCC on GNU/Linux',
            description='Debug build configuration for CMSIS.',
            
            buildConfigurationName='stm32h103_cmsis_linux_aep_gcc_Debug',
        ...
        Configuration(
            id='config.os.hal.architecture.arm.cortexm.tests.cmsis.stm32h103.linux.aep.gcc.release',
            name='Release STM32-H103 CMSIS configuration with ARM Embedded GCC on GNU/Linux',
            description='Release build configuration for CMSIS.',
            
            buildConfigurationName='stm32h103_cmsis_linux_aep_gcc_Release',
