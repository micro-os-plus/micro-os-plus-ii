...
Component(
    id='component.os.hal.arch.synthetic.posix.diagnostics',
    ...
    children=[
        ...
        Component(
            id='component.os.hal.arch.synthetic.posix.diagnostics.trace',
            name='Synthetic POSIX trace implementation',
            description='Implementation to output data from the trace class.',
            
            headerDefinition='OS_INCLUDE_HAL_ARCH_SYNTHETIC_POSIX_DIAGNOSTICS_TRACEIMPLEMENTATION',
