...
# GCC 4.6 x64
Configuration(
    id='IDPREFIX.ARTEFACTNAME.osx.x64.gcc46.debug',
    name='Debug OS X ARTEFACTDESCRIPTION configuration with x86_64 GCC 4.6',
    description='Debug build configuration for ARTEFACTDESCRIPTION.',
    
    buildConfigurationName='osx_ARTEFACTNAME_x64_gcc46_Debug',
...
Configuration(
    id='IDPREFIX.ARTEFACTNAME.osx.x64.gcc46.release',
    name='Release OS X ARTEFACTDESCRIPTION configuration with x86_64 GCC 4.6',
    description='Release build configuration for ARTEFACTDESCRIPTION.',
    
    buildConfigurationName='osx_ARTEFACTNAME_x64_gcc46_Release',
...
# GCC 4.6 x32
Configuration(
    id='IDPREFIX.ARTEFACTNAME.osx.x32.gcc46.debug',
    name='Debug OS X ARTEFACTDESCRIPTION configuration with i386 GCC 4.6',
    description='Debug build configuration for ARTEFACTDESCRIPTION.',
    
    buildConfigurationName='osx_ARTEFACTNAME_x32_gcc46_Debug',
...
Configuration(
    id='IDPREFIX.ARTEFACTNAME.osx.x32.gcc46.release',
    name='Release OS X ARTEFACTDESCRIPTION configuration with i386 GCC 4.6',
    description='Release build configuration for ARTEFACTDESCRIPTION.',
    
    buildConfigurationName='osx_ARTEFACTNAME_x32_gcc46_Release',
