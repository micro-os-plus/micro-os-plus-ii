...
# ----- GCC 4.8 x64 -----------------------------------------------------------
Configuration(
    id='IDPREFIX.ARTEFACTNAME.linux.x64.gcc48.debug',
    name='Debug GNU/Linux ARTEFACTDESCRIPTION configuration with x86_64 GCC 4.8',
    description='Debug build configuration for ARTEFACTDESCRIPTION.',
    
    buildConfigurationName='linux_ARTEFACTNAME_x64_gcc48_Debug',
...
Configuration(
    id='IDPREFIX.ARTEFACTNAME.linux.x64.gcc48.release',
    name='Release GNU/Linux ARTEFACTDESCRIPTION configuration with x86_64 GCC 4.8',
    description='Release build configuration for ARTEFACTDESCRIPTION.',
    
    buildConfigurationName='linux_ARTEFACTNAME_x64_gcc48_Release',
...
# ----- GCC 4.8 x32 -----------------------------------------------------------
Configuration(
    id='IDPREFIX.ARTEFACTNAME.linux.x32.gcc48.debug',
    name='Debug GNU/Linux ARTEFACTDESCRIPTION configuration with i386 GCC 4.8',
    description='Debug build configuration for ARTEFACTDESCRIPTION.',
    
    buildConfigurationName='linux_ARTEFACTNAME_x32_gcc48_Debug',
...
Configuration(
    id='IDPREFIX.ARTEFACTNAME.linux.x32.gcc48.release',
    name='Release GNU/Linux ARTEFACTDESCRIPTION configuration with i386 GCC 4.8',
    description='Release build configuration for ARTEFACTDESCRIPTION.',
    
    buildConfigurationName='linux_ARTEFACTNAME_x32_gcc48_Release',
